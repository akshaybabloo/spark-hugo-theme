...
import { faFacebook, faGithub, faLinkedin, faPinterest, faReddit, faXTwitter } from '@fortawesome/free-brands-svg-icons'
import {
	faEnvelope,
	faExternalLinkAlt,
	faHashtag,
...
export const twitter = icon({ prefix: 'fab', iconName: 'x-twitter' }, { transform: { size: 30 } })
...
export const rss = icon({ prefix: 'fas', iconName: 'rss' }, { transform: { size: 20 } })
...
export const pen = icon({ prefix: 'fas', iconName: 'pen' })
export const arrowRight = icon({ prefix: 'fas', iconName: 'arrow-right' })
export const arrowLeft = icon({ prefix: 'fas', iconName: 'arrow-left' })
